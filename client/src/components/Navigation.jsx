...
import { PlusIcon, MagnifyingGlassIcon, BellIcon } from '@heroicons/react/20/solid'
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex h-16 justify-between">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0 sm:border-r sm:pr-4">
                  <button
                    type="button"
                  ...
                  <Menu as="div" className="relative ml-3">
                    <div>
                      <Menu.Button className="flex items-center rounded-full w-42 space-x-2 px-2 py-1 bg-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                        <div className='h-8 w-8 rounded-full flex justify-center items-center bg-lime-500'>
